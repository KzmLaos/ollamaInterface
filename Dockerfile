...
RUN apt-get install -y libreadline-dev libncursesw5-dev libssl-dev libsqlite3-dev tk-dev libgdbm-dev libc6-dev 
libbz2-dev libffi-dev automake python3-dev python3-pip #python-venv
...
RUN pip3 install numpy jupyter pandas joblib xgboost scikit-image scikit-learn python-afl voila ipyvuetify 
jupyter_contrib_nbextensions voila-vuetify bqplot deap --break-system-packages
